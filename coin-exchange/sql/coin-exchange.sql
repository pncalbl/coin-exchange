...
CREATE TABLE `account_detail`  (
  ...
  `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '日期',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `admin_address`  (
  ...
  `status` int NULL DEFAULT NULL COMMENT '1:归账(冷钱包地址),2:打款,3:手续费',
...
CREATE TABLE `admin_bank`  (
  ...
  `coin_id` bigint NULL DEFAULT NULL COMMENT '充值转换换币种ID',
  `coin_name` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '币种名称',
  `status` tinyint NULL DEFAULT NULL COMMENT '状态：0-无效；1-有效；',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `cash_recharge`  (
  ...
  `status` tinyint NOT NULL COMMENT '状态：0-待审核；1-审核通过；2-拒绝；3-充值成功；',
  `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `last_update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  ...
  `last_time` datetime NULL DEFAULT NULL COMMENT '最后确认到账时间。',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `cash_recharge_audit_record`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `order_id` bigint NULL DEFAULT NULL COMMENT '充值订单号',
...
CREATE TABLE `cash_withdraw_audit_record`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `order_id` bigint NULL DEFAULT NULL COMMENT '提币订单号',
  `status` tinyint NULL DEFAULT NULL COMMENT '状态',
  `remark` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '审核备注',
  `step` tinyint NULL DEFAULT NULL COMMENT '当前审核级数',
  `audit_user_id` bigint NULL DEFAULT NULL COMMENT '审核人ID',
...
CREATE TABLE `cash_withdrawals`  (
  ...
  `step` tinyint NULL DEFAULT NULL COMMENT '当前审核级数',
  `status` tinyint NOT NULL COMMENT '状态：0-待审核；1-审核通过；2-拒绝；3-提现成功；',
  `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `last_update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `last_time` datetime NULL DEFAULT NULL COMMENT '最后确认提现到账时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `userid`(`user_id`) USING BTREE,
  INDEX `status`(`status`) USING BTREE
...
CREATE TABLE `coin`  (
  ...
  `round` tinyint NOT NULL COMMENT '小数位数',
  ...
  `withdraw_flag` tinyint NULL DEFAULT 1 COMMENT '提现开关',
  `recharge_flag` tinyint NULL DEFAULT 1 COMMENT '充值开关',
  `last_update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `coin_config`  (
  `id` bigint NOT NULL COMMENT '币种ID(对应coin表ID)',
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '币种名称',
  ...
  `status` int NOT NULL DEFAULT 0 COMMENT '是否可用0不可用,1可用',
...
CREATE TABLE `coin_recharge`  (
  ...
  `status` int NULL DEFAULT 0 COMMENT '状态：0-待入帐；1-充值失败，2到账失败，3到账成功；',
...
CREATE TABLE `coin_server`  (
  ...
  `running` int NOT NULL COMMENT '服务是否运行 0:正常,1:停止',
  `wallet_number` bigint NOT NULL COMMENT '钱包服务器区块高度',
...
CREATE TABLE `coin_withdraw`  (
  ...
  `block_num` int UNSIGNED NULL DEFAULT 0 COMMENT '区块高度',
...
CREATE TABLE `entrust_order`  (
  ...
  `market_type` tinyint NULL DEFAULT NULL COMMENT '市场类型（1：币币交易，2：创新交易）',
  ...
  `price_type` tinyint NOT NULL DEFAULT 2 COMMENT '价格类型：1-市价；2-限价',
  `trade_type` tinyint NULL DEFAULT NULL COMMENT '交易类型：1-开仓；2-平仓',
  `type` tinyint NOT NULL COMMENT '买卖类型：1-买入；2-卖出\r\n2 卖出\r\n',
...
CREATE TABLE `forex_account_detail`  (
  ...
  `type` tinyint NULL DEFAULT NULL COMMENT '收支类型：开仓；2-平仓；',
...
CREATE TABLE `forex_close_position_order`  (
  ...
  `entrust_order_id` bigint NULL DEFAULT NULL COMMENT '委托订单号',
  `order_id` bigint NULL DEFAULT NULL COMMENT '成交订单号',
...
CREATE TABLE `forex_open_position_order`  (
  ...
  `market_id` bigint NULL DEFAULT NULL COMMENT '交易对ID',
  `market_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '交易对名称',
  `coin_id` bigint NULL DEFAULT NULL COMMENT '结算币种',
  `type` tinyint NULL DEFAULT NULL COMMENT '持仓方向：1-买；2-卖',
  `account_id` bigint NULL DEFAULT NULL COMMENT '资金账户ID',
  `entrust_order_id` bigint NULL DEFAULT NULL COMMENT '委托订单',
  `order_id` bigint NULL DEFAULT NULL COMMENT '成交订单号',
  ...
  `status` tinyint NULL DEFAULT NULL COMMENT '状态：1：未平仓；2-已平仓',
  `last_update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `created` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_create_time`(`created`) USING BTREE,
  INDEX `idx_update_time`(`last_update_time`) USING BTREE,
...
CREATE TABLE `market`  (
  ...
  `type` tinyint NOT NULL COMMENT '类型：1-数字货币；2：创新交易',
  `trade_area_id` bigint NOT NULL COMMENT '交易区域ID',
  `sell_coin_id` bigint NULL DEFAULT NULL COMMENT '卖方市场ID',
  ...
  `sort` int NOT NULL DEFAULT 0 COMMENT '排序列',
...
CREATE TABLE `mine_pool_member`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `mine_pool_id` bigint NULL DEFAULT NULL COMMENT '矿池ID',
  `user_id` bigint NULL DEFAULT NULL COMMENT '用户ID',
...
CREATE TABLE `sms`  (
  ...
  `status` int NULL DEFAULT NULL COMMENT '短信状态：0，默认值；大于0，成功发送短信数量；小于0，异常；',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `last_update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '发送时间',
  `created` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_user_log`  (
  ...
  `user_id` bigint NULL DEFAULT NULL COMMENT '用户Id',
  `type` smallint NULL DEFAULT NULL COMMENT '日志类型 1查询 2修改 3新增 4删除 5导出 6审核',
...
CREATE TABLE `trade_area`  (
  ...
  `type` tinyint NULL DEFAULT NULL COMMENT '类型：1-数字货币交易；2-创新交易使用；',
  `coin_id` bigint NULL DEFAULT NULL COMMENT '结算币种（仅创新交易需要使用）',
  ...
  `status` tinyint NULL DEFAULT NULL COMMENT '状态',
  `base_coin` bigint NULL DEFAULT NULL COMMENT '是否作为基础结算货币,0否1是 供统计个人账户使用',
  `last_update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `created` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `turnover_order`  (
  ...
  `sell_coin_id` bigint NOT NULL COMMENT '卖方币种ID',
  `sell_order_id` bigint NOT NULL COMMENT '卖方委托订单ID',
  ...
  `buy_coin_id` bigint NOT NULL COMMENT '买方币种ID',
  `buy_order_id` bigint NOT NULL COMMENT '买方委托订单ID',
...
CREATE TABLE `user`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `type` tinyint NULL DEFAULT 1 COMMENT '用户类型：1-普通用户；2-代理人',
  ...
  `auth_status` tinyint NULL DEFAULT 0 COMMENT '认证状态：0-未认证；1-初级实名认证；2-高级实名认证',
  ...
  `level` int NULL DEFAULT NULL COMMENT '代理商级别',
  `authtime` datetime NULL DEFAULT NULL COMMENT '认证时间',
  `logins` int NULL DEFAULT 0 COMMENT '登录数',
  ...
  `is_deductible` int NULL DEFAULT 0 COMMENT '0 否 1是  是否开启平台币抵扣手续费',
  `reviews_status` int NULL DEFAULT 0 COMMENT '审核状态,1通过,2拒绝,0,待审核',
  ...
  `refe_auth_id` bigint NULL DEFAULT NULL COMMENT '引用认证状态id',
  `last_update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `status`(`status`) USING BTREE,
...
CREATE TABLE `user_address`  (
  ...
  `last_update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `markid` bigint NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `user_auth_audit_record`  (
  `id` bigint NOT NULL COMMENT '主键',
  `auth_code` bigint NULL DEFAULT NULL COMMENT '对应user_auth_info表code',
  `user_id` bigint NULL DEFAULT NULL COMMENT '用户ID',
  `status` tinyint NULL DEFAULT NULL COMMENT '状态1同意2拒絕',
...
CREATE TABLE `user_auth_info`  (
  ...
  `serialno` int NULL DEFAULT NULL COMMENT '序号：1-身份证正面照；2-身份证反面照；3-手持身份证照片；',
  `last_update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `created` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE `user_favorite_market`  (
  `id` bigint NOT NULL COMMENT '主键',
  `type` int NULL DEFAULT NULL COMMENT '交易对类型：1-币币交易；2-创新交易；',
  `user_id` bigint NULL DEFAULT NULL COMMENT '用户ID',
  `market_id` bigint NULL DEFAULT NULL COMMENT '交易对ID',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `user_login_log`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` bigint NULL DEFAULT NULL COMMENT '用户ID',
  `client_type` tinyint NULL DEFAULT NULL COMMENT '客户端类型\r\n            1-PC\r\n            2-IOS\r\n            3-Android',
...
CREATE TABLE `wallet_collect_task`  (
  ...
  `user_id` bigint NULL DEFAULT NULL COMMENT '来自哪个用户',
  ...
  `status` int NOT NULL DEFAULT 0 COMMENT '是否处理',
...
CREATE TABLE `web_config`  (
  ...
  `sort` smallint NULL DEFAULT 1 COMMENT '权重',
  `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE `work_issue`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` bigint NULL DEFAULT NULL COMMENT '用户id(提问用户id)',
  `answer_user_id` bigint NULL DEFAULT NULL COMMENT '回复人id',
